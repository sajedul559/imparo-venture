        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('homePage.update',$page->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 col-md-6">
                            <label class="form-label">Title One<span class="error">*</span></label>
                            <input name="title_one" type="text" class="form-control slug-input" required="" placeholder="Name"
                                   value="{{$page->title_one}}">
                            @error('title_one')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div> 
                        <div class="mb-3 col-md-6">
                            <label class="form-label">Title Two<span class="error">*</span></label>
                            <input name="title_two" type="text" class="form-control" required="" placeholder="Name"
                                   value="{{ $page->title_two }}">
                            @error('title_two')
                            <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="row m-0 p-0">
                                ...
                                <div id='img_contain col-md-4 px-2'>
                                    <img id="image-preview" align='middle' src="{{asset('images/page/home/')}}/{{$page->image}}"
                                        alt="your image"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="radio" id="status_no" name="status" class="form-check-input"
                                       ...
                                       class="custom-control-input"
                                       @if( $page->status=='inactive') checked @endif>
