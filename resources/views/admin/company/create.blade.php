<x-admin.app >
    ...
    <div class="row pt-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Company Create Form</h4>
                    <form id="submitform" data-parsley-trigger="keyup" class="repeater"
                        action="{{ route('admin.company.store') }} " method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                            ...
                                            <div id="collapseTwo" class="collapse container mt-4 show" data-parent="#accordion">
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        ...
                                                        <input type="text" class="form-control mb-2 mb-md-0" value="{{old('intro_title')}}" name="intro_title" placeholder="Enter title" required />
                                                    ...
                                                    <div class="col-md-12 mt-1 mb-3">
                                                        ...
                                                        <textarea rows="4" name="intro_description" type="text" class="form-control"
                                                            value="{{ old('intro_description') }}" required="required" placeholder="Enter who we are short description" ></textarea>
                                                                ...
                                                                <div data-repeater-list="gallery">
                                                                    <div data-repeater-item class="repeater-item">
                                                                        <div class="form-group row">
                                                                            <div class="mb-3 col-md-6">
                                                                                <label for="">Title<span class="text-danger">*</span></label>
                                                                                <input type="text" class="form-control mb-2 mb-md-0" name="gallery_title" placeholder="Enter title" required />
                                                                            ...
                                                                            <div class="mb-3 col-md-10">
                                                                                ...
                                                                                <textarea rows="8" cols="15" name="gallery_description" type="text" class="form-control"
                                                                                    value="{{ old('gallery_description') }}" required="required" placeholder="Enter who we are short description" ></textarea>
