                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        <div id="progress">
                                                            <!--begin::Form group-->
                                                            <div class="form-group">
                                                                <div data-repeater-list="progress">
                                                                    @foreach ($project->content['progress_status'] as $key => $data)
                                                                    <div data-repeater-item class="repeater-item" id="removeProgress-{{$key}}">
                                                                        <div class="form-group row">
                                                                            <div class="mb-3 col-md-3">
                                                                                <label for="">Progress Name<span class="text-danger">*</span></label>
                                                                                <input type="text" class="form-control mb-2 mb-md-0" name="progress_name" value="{{$project->content['progress_name'][$key]}}" placeholder="Enter name" required />
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input type="file" class="form-control" value="@isset($project->content['progress_images'])
                                                                                {{ $project->content['progress_images'][$key]}}
                                                                                @endisset" name="progress_images" >
                                                                                {{-- <img src="{{asset('images/page/project/progress')}}/{{$project->content['progress_images'] [$key]}}" class=" mt-2" height="100" width="150"alt=""> --}}

                                                                                <input type="hidden" id="imageOne" class="form-control" value="@isset($project->content['progress_images'])
                                                                                 {{ $project->content['progress_images'][$key]}}
                                                                                  @endisset" name="progress_images_old" >
                                                                            </div>
                                                                            <div class="col-md-1 mt-4 pt-1">
                                                                                ...
                                                                                onclick="deleteProgressImage({{$key}},'{{$project->content['progress_images'][$key] }}')">
                                                                                    <i class="la la-trash-o"></i>Delete
                                                                                </a>
                                                                            </div>
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <a href="javascript:;" data-repeater-create class="btn btn-success" id="AddMorekkkk">
                                                                    <i class="la la-plus"></i>Add More Progress
                                                                </a>
                                                            </div>
                                                            <!--end::Form group-->
                                                        </div>
