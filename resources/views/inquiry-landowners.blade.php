...
<div class="inquiry-inner-banner"><img
    src="https://edison-properties.com/dev/admin/uploads/page/landowners/1623567389L76Qh.jpg" alt="">
    ...
    <div class="row">
        ...
        <div class="contact-from-right p-0 col-md-6">
            <div class="contact-from-right__inner">
                <img src="https://edison-properties.com/dev/admin/uploads/page/landowners/1623567389X98wO.jpg"
                    alt="">
            </div>
        </div>
    </div>
